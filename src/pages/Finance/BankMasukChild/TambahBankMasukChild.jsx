  ...
  const saveBankMasukChild = async (e) => {
    ...
    if (isFailedValidation) {
      ...
      try {
        ...
        await axios.post(`${tempUrl}/saveBankMasukChild`, {
          noBukti,
          tglBankMasuk,
...
export default TambahBankMasukChild;
