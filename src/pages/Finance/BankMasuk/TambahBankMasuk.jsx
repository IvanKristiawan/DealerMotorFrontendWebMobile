...
const TambahBankMasuk = () => {
  ...
  const [inputTglBankMasuk, setInputTglBankMasuk] = useState(
  ...
  const saveBankMasuk = async (e) => {
    ...
    let tglBankMasuk =
      inputTglBankMasuk?.getFullYear() +
      "-" +
      (inputTglBankMasuk?.getMonth() + 1).toLocaleString("en-US", {
        minimumIntegerDigits: 2,
        useGrouping: false
      }) +
      "-" +
      inputTglBankMasuk?.getDate().toLocaleString("en-US", {
        minimumIntegerDigits: 2,
        useGrouping: false
      });

    let isFailedValidation = inputTglBankMasuk === null || kodeCOA.length === 0;
        ...
        <Box sx={textFieldContainer}>
          <Box sx={textFieldWrapper}>
            ...
            <DatePicker
              ...
              selected={inputTglBankMasuk}
              onChange={(e) => setInputTglBankMasuk(e)}
              customInput={
                <TextField
                  error={error && inputTglBankMasuk === null && true}
                  helperText={
                    error &&
                    inputTglBankMasuk === null &&
                    "Tanggal harus diisi!"
                  }
                  sx={{ width: "100%" }}
                  size="small"
