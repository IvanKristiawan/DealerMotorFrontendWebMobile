...
const UbahBankMasuk = () => {
  ...
  const getBankMasukById = async () => {
    ...
    setInputTglBankMasuk(pickedBankMasuk.data.tglBankMasuk);
    setKodeCOA(pickedBankMasuk.data.COA.kodeCOA);
    setKeterangan(pickedBankMasuk.data.keterangan);
    setLoading(false);
  };
