...
const UbahKasMasuk = () => {
  ...
  const getKasMasukById = async () => {
    ...
    setInputTglKasMasuk(pickedKasMasuk.data.tglKasMasuk);
    setKodeCOA(pickedKasMasuk.data.COA.kodeCOA);
    setKeterangan(pickedKasMasuk.data.keterangan);
    setLoading(false);
  };
